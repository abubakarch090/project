          ...
          <div className="flex justify-between    ">
            <div className="flex flex-col w-[60%] mt-6 ">
              ...
              <div className='flex '>
                ...
                <input className="bg-white w-[85%] h-12 mt-2 rounded-lg shadow-lg p-2"
            ...
            <div className="bg-black w-[30%] h-72 rounded-lg shadow-lg mt-6  ">
              <div className="bg-white w-full h-72 rounded-lg shadow-lg   ">
                ...
                <p className='text-sm text-center italic'>100% completion of  you profile will help 
                your get more reach.</p>
              </div>
